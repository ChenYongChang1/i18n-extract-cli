...
import execCommand, { translateLaguage } from "./core";
import { exportModuleExcel } from "./utils/exportExcel";
import { mergeLanguage } from "./utils/merge";
...
program
  ...
  .action((opt) => {
    ...
    translateLaguage(options as typeof opt);
  });
...
program
  ...
  .action((opt) => {
    ...
    exportModuleExcel(options as typeof opt);
  });
...
program
  ...
  .action((opt) => {
    ...
    mergeLanguage(options as typeof opt);
  });
